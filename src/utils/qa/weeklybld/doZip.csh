...
ssh -n qateam@hgdownload-sd "rm /mirrordata/apache/htdocs/admin/jksrc.v*.zip"
...
ssh -n qateam@hgdownload-sd "cd /mirrordata/apache/htdocs/admin/;ln -s jksrc.v${BRANCHNN}.zip jksrc.zip"
